...
import continuingCareAssistant from "../../../assets/featuredPrograms/continuingCareAssisstant.jpg";
import studyInGermany from "../../../assets/featuredPrograms/studyInGermany.jpg";
import studyInAustralia from "../../../assets/featuredPrograms/studyInAustrillia.jpg";
import newZealandResidency from "../../../assets/featuredPrograms/longtermResidencyPathwayNewZealand.jpg";
import travelToSpain from "../../../assets/featuredPrograms/TravelToSpain.jpg";
import skillsMigration from "../../../assets/featuredPrograms/generalSkillMigrantVisa.jpg";
import studyInUK from "../../../assets/featuredPrograms/StudyInUnitedKingdom.jpg";
import studyAbroad from "../../../assets/featuredPrograms/studyAbroad.jpg";

const programs = [
  {
    image: continuingCareAssistant,
    title: "Continuing Care Assistant",
    description: "Start your career in healthcare and make a difference.",
  },
  {
    image: studyInGermany,
    title: "Free Tuition in Germany",
    description:
      "Study and work in Germany without the burden of tuition fees.",
  },
  {
    image: studyInAustralia,
    title: "Study in Australia",
    description:
      "Unlock opportunities at top Australian universities and gain global exposure.",
  },
  {
    image: newZealandResidency,
    title: "New Zealand Residency",
    description:
      "Your long-term route to residency in the beautiful landscapes of NZ.",
  },
  {
    image: travelToSpain,
    title: "Travel to Spain",
    description:
      "Experience the vibrant culture, history, and beauty of Spain.",
  },
  {
    image: skillsMigration,
    title: "Skills Migration",
    description:
      "Take the next step in your career abroad with skilled migration programs.",
  },
  {
    image: studyInUK,
    title: "Study in the UK",
    description:
      "Explore educational opportunities in top universities across the UK.",
  },
  {
    image: studyAbroad,
    title: "Study Abroad Program",
    description:
      "Open the door to global education experiences around the world.",
  },
];
...
export default function FeaturedPrograms() {
  ...
  return (
    <section
      ...
      className="scroll-mt-20 min-h-screen w-full bg-zinc-950 text-white overflow-hidden flex flex-col justify-center items-center py-16 md:py-24 border-t border-white/5"
    >
