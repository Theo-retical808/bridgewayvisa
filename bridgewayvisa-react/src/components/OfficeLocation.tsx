  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center">
        ...
        {/* Updated grid layout to hold both locations side-by-side on larger screens */}
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-12 relative z-10 max-w-6xl">
          {/* Head Office - Manila */}
          <div className="w-full bg-zinc-900/50 border border-zinc-800 rounded-2xl overflow-hidden backdrop-blur-sm flex flex-col justify-between shadow-2xl">
            <div>
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-zinc-400 text-sm md:text-base leading-relaxed mb-4">
                  GM Floor, MC Premiere Building, Balintawak, EDSA, Quezon City,
                  Philippines.
                </p>
              </div>
            </div>
          ...
          <div className="w-full bg-zinc-900/50 border border-zinc-800 rounded-2xl overflow-hidden backdrop-blur-sm flex flex-col justify-between shadow-2xl">
            <div>
              <div className="w-full aspect-video bg-zinc-950 relative">
                <iframe
                  className="w-full h-full"
                  src="https://www.youtube.com/embed/NhSijB4gMGw"
                  title="Bridgeway Visa Travel Corporation Cebu Branch Location"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  allowFullScreen
                />
              </div>
              <div className="p-6 md:p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2.5 py-1 text-xs font-semibold bg-zinc-900 text-zinc-400 rounded-md border border-zinc-800/30">
                    Cebu Branch
                  </span>
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-2">
                ...
                <p className="text-zinc-400 text-sm md:text-base leading-relaxed mb-4">
                  Copenhagen East Residences Compound, AC Cortes Avenue, Mandaue
