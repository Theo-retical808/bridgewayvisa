      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm leading-relaxed mb-6 text-zinc-400">
              Connecting the world's best talent with exceptional opportunities.
              Your trusted partner in global mobility and visa consulting.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-white uppercase text-xs tracking-widest mb-6">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <p className="text-sm mb-4 text-zinc-400">
              Book your free assessment today and take the first step toward
        ...
        <div className="mt-16 pt-8 border-t border-zinc-800/50 text-center">
          <p className="text-xs text-zinc-500">
            © {new Date().getFullYear()} Bridgeway Visa Travel Corporation. All
            Rights Reserved.
          </p>
        </div>
      </div>
