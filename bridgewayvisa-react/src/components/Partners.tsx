...
const partners = [
  {
    logo: '/assets/ourPartners/skylineInternationalCollege.webp',
    name: 'Skyline International College',
    tagline: 'Career-Focused Courses',
    features: ['Affordable Tuition', 'Online & On-Campus Options', 'Official Accreditation', 'Work Opportunities'],
    quote: 'Skyline blends practical education with affordability.',
  },
  {
    logo: '/assets/ourPartners/timesEducation.webp',
    name: 'Times Education',
    tagline: 'Practical, career-oriented learning',
    features: ['Practical Training', 'Budget-Friendly Tuition', 'ASQA & CRICOS Accredited', 'Industry-Aligned Programs'],
    quote: 'Delivers skills-focused learning with flexibility.',
  },
  {
    logo: '/assets/ourPartners/GoozingMigration.webp',
    name: 'Goozing Immigration',
    tagline: 'Personalized visa assistance',
    features: ['Tailored Visa Assistance', 'Education Partnerships', 'Responsive Support', 'Migration Guidance'],
    quote: 'Guiding clients with personalized immigration solutions.',
  },
  {
    logo: '/assets/ourPartners/canberraCollegeOfManagement&Technology.webp',
    name: 'Canberra College (CCMT)',
    tagline: 'Business and tech disciplines',
    features: ['Specialized Programs', 'Local Accessibility', 'Hands-On Learning', 'Community Engagement'],
    quote: 'Vocational learning rooted in real-world experience.',
  },
  {
    logo: '/assets/ourPartners/Adventus.io.webp',
    name: 'Adventus',
    tagline: 'Global provider of ICT services',
    features: ['24/7 ICT support', 'Simplifies admissions', 'Strategic industry partnerships', 'Employee perks & healthcare'],
    quote: 'Empowers institutions and students through innovation.',
  },
  {
    logo: '/assets/ourPartners/InternationalBusinessUniversity.webp',
    name: 'International Business University',
    tagline: 'Innovative academic pathways',
    features: ['Digital transformation focus', 'Real-world application', 'Modern resources', 'Career-readiness programs'],
    quote: 'Helping students grow via future-ready education.',
  },
  {
    logo: '/assets/ourPartners/GEEBEE.webp',
  ...
  {
    logo: '/assets/ourPartners/TRENT.webp',
    name: 'TRENT Global College',
    tagline: 'Practical Singapore-based programs',
    features: [],
    description: 'Short course durations with paid internships and hands-on experience.',
    quote: 'Combines education with real-world Singapore experience.',
  },
  {
    logo: '/assets/ourPartners/FLEEMING.webp',
...
export default function Partners() {
  ...
  useEffect(() => {
    ...
    track.addEventListener('touchstart', onStart as EventListener, { passive: true })
  ...
  return (
    <section id="partners" className="scroll-mt-20 min-h-screen w-full bg-zinc-950 py-16 md:py-24 overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-red-700 text-center mb-12 tracking-wide">Our Partners</h2>

        <div className="overflow-hidden w-full relative" style={{ maskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)', WebkitMaskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent)' }}>
          <div ref={trackRef} className="partners-scroll-container gap-8">
            {tripled.map((partner, idx) => (
              <div key={idx} className="partner-card bg-black p-8 rounded-xl shadow-lg border border-white transition-transform duration-300 hover:scale-105 hover:border-red-300">
                <div className="flex-grow">
                  ...
                  <p className="text-gray-300 text-sm italic mb-2">{partner.tagline}</p>
                  ...
                  {partner.description && <p className="text-gray-300 text-sm mb-2">{partner.description}</p>}
                </div>
                <div className="mt-6 pt-4 border-t border-gray-800">
                  <p className="text-gray-400 italic text-sm">{partner.quote}</p>
                </div>
              </div>
            ))}
          </div>
